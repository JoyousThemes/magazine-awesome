...
<div id="page" class="hfeed site">
	<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'magazine-awesome' ); ?></a>
	<?php do_action('magazine_awesome_before_header'); ?>
	 ...
	 if ( is_woocommerce()  ) { 
	  ...
	  $breadcrumb_section = get_theme_mod( 'breadcrumb_section',true );
	    if( $breadcrumb_section ) { ?>    
		   <div class="breadcrumb" style="background-image: url('<?php echo magazine_awesome_featured_header(); ?>');"> 
