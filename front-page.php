...
if ( 'posts' == get_option( 'show_on_front' ) ) { 
    ...
    if( get_theme_mod('service_field',true) ) {
			...
			<div class="services-wrapper">
			    <div class="container"><?php  
					...
					if( $query->have_posts()) : ?>	
							...
							<?php do_action('magazine_awesome_service_title');
							 $i = 1; 
							 if($service_title): ?>
	 ...
	 do_action( 'magazine_awesome_after_slider_part' );
    if( get_theme_mod('enable_recent_post_service',true) ) :
	   	do_action('magazine_awesome_recent_post_before');  
		magazine_awesome_recent_posts();  
	    do_action('magazine_awesome_recent_post_after');
    endif;
