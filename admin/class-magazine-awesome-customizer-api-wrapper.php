...
if( ! class_exists('Magazine_Awesome_Customizer_API_Wrapper') ) {
	class Magazine_Awesome_Customizer_API_Wrapper {
		...
		public static function getInstance($options) {
			if(! self::$_instance) {
				self::$_instance = new Magazine_Awesome_Customizer_API_Wrapper($options);
			}
		...
		public function add_control($wp_customize, $field_id, $field_details) {
			...
			switch ($type) {
				...
				case 'icons-picker':
					$wp_customize->add_control( 
						new Magazine_Awesome_Icon_Customizer_Icon_Picker_Control(
							$wp_customize, 
							$field_id,
							array(
								'label' => isset($label) ? $label : '',
