...
if( !function_exists('magazine_awesome_icon_add_icon_picker_control') ) :
	function magazine_awesome_icon_add_icon_picker_control( $wp_customize ) {
		class Magazine_Awesome_Icon_Customizer_Icon_Picker_Control extends WP_Customize_Control {
			...
			?>
				<label data-title="<?php esc_attr_e('Inline picker','magazine-awesome'); ?>">
...
add_action( 'customize_register', 'magazine_awesome_icon_add_icon_picker_control' );
